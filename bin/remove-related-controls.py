...
def main():
    ...
    for line in args.king:
        ...
        if key1 in case_set and key2 in control_set:
            remove_set.add(key2)
        elif key1 in control_set and key2 in case_set:
            remove_set.add(key1)
        else:
            continue
    ...
    # Remove samples here rather than subtract from sets so order is same as original case and control files
